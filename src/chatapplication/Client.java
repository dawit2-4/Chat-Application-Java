...
public class Client extends JFrame implements ActionListener {
	...
	Client() {
		...
		p1.setBounds(0,0,330,60);
		p1.setBackground(new Color(21, 28, 114, 100));
		p1.setLayout(null);
		f.add(p1);
		...
		morevert.setBounds(310, 20, 20, 25);
		p1.add(morevert);
		
		
		JLabel name = new JLabel("Delal");
		name.setBounds(90, 15, 100, 20);
		name.setFont(new Font("SAN_SERIF", Font.BOLD, 12));
		p1.add(name);
		
		JLabel status = new JLabel("Active Now");
		status.setBounds(90, 30, 100, 20);
		status.setFont(new Font("SAN_SERIF", Font.BOLD, 8));
		p1.add(status);
		
		
		a1 = new JPanel ();
		a1.setBounds(4, 63, 322, 400);
		f.add(a1);
		
		text = new JTextField();
		text.setBounds(4, 470, 250, 30);
		text.setFont(new Font("SAN_SERIF", Font.PLAIN, 12));
		f.add(text);
		
		JButton send = new JButton("send");
		send.setBounds(255, 470, 74, 30);
		send.setBackground(new Color(21, 28, 114));
